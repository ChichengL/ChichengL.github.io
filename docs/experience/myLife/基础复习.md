...
![https握手](https://s21.ax1x.com/2025/07/29/pVYhqiT.md.png)
...
> head->入环口的距离为 a 入环口到相遇点的距离为 b，剩下环内距离为 c
> 设 fast 走了 n 圈，slow 走了 m 圈后两者相遇
>
> 那么 a + n(b+c)+b = 2(a+m(b+c)+b) ---> a + n(b+c)+b = 2a + 2m(b+c) + 2b;
> a + b = (n-2m)(b+c);
> a = (n-2m-1)(b+c) + c
>
> 那么一个新指针从 head 走到入环口，slow 可以从 b 走到入环口
